...
def intersection(set1:dict, set2:dict) -> dict:
    ...
    """
    return complement(setCasting(union(setCasting(complement(set1)), setCasting(complement(set2)))))

#* o(u^2*n*m)
#* Declarative Functional
def difference(set1:set, set2:set) -> dict:
    """
    given 2 sets, being set1 and set2, it uses higher order functions (being union and complement)
...
#* o(u^2*n*m)
#* Declarative Functional
def simetricDifference(set1:set, set2:set) -> dict:
    """
    given 2 sets, being set1 and set2, it uses higher order functions (being union and complement)
